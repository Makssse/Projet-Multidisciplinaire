...
i2c = I2C(1, sda=Pin(6), scl=Pin(7), freq=100000)   # RaspberryPi pico sur le port I2C1 
...
scd.persist_settings() #fait que les paramètres ne seront pas réinitialisé

scd.start_periodic_measurement() #prend une mesure toute les 5s # start_low_periodic_measurement() is a lower power alternative toutes les 30s
