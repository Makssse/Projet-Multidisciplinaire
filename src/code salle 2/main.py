#code pour la pi pico de la salle 2
import time
...
#sys.path.append('/src/code salle 2/lib')
...
# --- CONFIGURATION MQTT
SALLE_ID = "salle2" # A CHANGER NVL PICO
IP_PICO = "10.40.1.21"   #  A CHANGER NVL PICO
MAC_PICO = "DE:AD:BE:EF:00:01" #  A CHANGER NVL PICO
